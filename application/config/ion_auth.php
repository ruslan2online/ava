...
|
*/
$config['collections']['users']          = 'ava_sys_users';
$config['collections']['groups']         = 'ava_sys_groups';
$config['collections']['login_attempts'] = 'ava_sys_login_attempts';
...
*/
$config['tables']['users']           = 'ava_sys_users';
$config['tables']['groups']          = 'ava_sys_groups';
$config['tables']['users_groups']    = 'ava_sys_users_groups';
$config['tables']['login_attempts']  = 'ava_sys_login_attempts';
 ...
 */
$config['site_title']                 = "avalab.ru";       	// Site Title, example.com
$config['admin_email']                = "cms@avalab.ru"; 	// Admin Email, admin@example.com
